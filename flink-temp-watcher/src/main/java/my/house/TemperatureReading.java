...
public class TemperatureReading extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3443922247357110282L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TemperatureReading\",\"namespace\":\"my.house\",\"doc\":\"Avro schema for holding a temperature sensor reading.\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"sensorId\",\"type\":\"int\"},{\"name\":\"temperature\",\"type\":\"float\"},{\"name\":\"datetimeMs\",\"type\":\"long\"}]}");
   ...
   */
  public static TemperatureReading fromByteBuffer(
   ...
   */
  public TemperatureReading(java.lang.CharSequence name, java.lang.Integer sensorId, java.lang.Float temperature, java.lang.Long datetimeMs) {
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: datetimeMs = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new TemperatureReading RecordBuilder
   */
  public static my.house.TemperatureReading.Builder newBuilder(my.house.TemperatureReading.Builder other) {
    if (other == null) {
      return new my.house.TemperatureReading.Builder();
    } else {
  ...
  /**
   * Creates a new TemperatureReading RecordBuilder by copying an existing TemperatureReading instance.
   ...
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TemperatureReading>
    ...
    public TemperatureReading build() {
      try {
        TemperatureReading record = new TemperatureReading();
        ...
        record.datetimeMs = fieldSetFlags()[3] ? this.datetimeMs : (java.lang.Long) defaultValue(fields()[3]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<TemperatureReading>
    WRITER$ = (org.apache.avro.io.DatumWriter<TemperatureReading>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<TemperatureReading>
    READER$ = (org.apache.avro.io.DatumReader<TemperatureReading>)MODEL$.createDatumReader(SCHEMA$);
